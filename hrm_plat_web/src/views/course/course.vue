		...
		<el-dialog title="添加或修改" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="course" label-width="80px" :rules="formRules" ref="course">
				...
				<el-form-item label="简介" prop="intro">
					<el-input v-model="course.courseDetail.intro" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="详情" prop="description">
					<el-input v-model="course.courseDetail.description" auto-complete="off"></el-input>
				</el-form-item>
			</el-form>
...
<script>
	export default {
		...
		methods: {
		    ...
		    getCourseLevels(){
                //发送请求到后台获取数据
                this.$http.get("/sysmanage/systemdictionaryitem/list?sn=courseLevel")
                    .then(result=>{
